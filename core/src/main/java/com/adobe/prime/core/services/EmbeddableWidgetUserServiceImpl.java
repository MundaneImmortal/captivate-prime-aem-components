...
@Component(metatype = false, immediate = true, label = "Captivate Prime Embeddable Widget User Service",
    description = "Captivate Prime Embeddable Widget User Service")
...
public class EmbeddableWidgetUserServiceImpl implements EmbeddableWidgetUserService
{
  ...
  public Pair<String, Long> getAccessTokenWithExpiry(SlingHttpServletRequest request, Page currentPage, String email)
  {
    ...
    try
    {
      ...
      Map<String, Object> adminConfigs = widgetService.getAvailaleAdminConfiguration(pageRsc);
